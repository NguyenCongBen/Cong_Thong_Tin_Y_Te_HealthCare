                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-8 col-sm-12">
                                ...
                                <ul className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item">Bệnh nhân</li> <li className="breadcrumb-item active">Hồ sơ bệnh nhân</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="body">
                                    <ul className="list-unstyled">
                                        <li>
                                            ...
                                            <div className="progress m-b-20"> <div className="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style={{ width: `${benhnhan.nhip_tim}%` }}   > <span className="sr-only">40% Hoàn thành (thành công)</span> </div>
                                            </div>
                                        </li>
                                                ...
                                                <div className="msg" style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                                                    {Array.isArray(cssk) && cssk.length > 0 ? (
                                                        cssk
                                                            ...
                                                            .map((e, index) => (
                                                                <div key={index} style={{ width: "auto" }}> <button
                                                                        style={{
                                                                            cursor: 'pointer',
                                                                            outline: 'none',
                                                                            padding: '10px 15px',
                                        ...
                                        <div class="tab-pane" id="kehoachdieutri">
                                            <div className="treatment-plan">
                                                ...
                                                <table className="table table-bordered table-striped billing-history">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td> <h5 className="billing-title">Bác sĩ ID <span className="invoice-number">#{benhnhan.id_bac_si}</span></h5>
                                                ...
                                                <div className="d-flex justify-content-end mt-3">
                                                    <button
                                                        style={{
                                                            cursor: 'pointer',
                                                            outline: 'none',
                                                            padding: '10px 25px', background: 'linear-gradient(45deg, #4CAF50, #81C784)',
                                                            color: 'white',
                                                            border: 'none',
                                                            borderRadius: '5px',
                                                            fontSize: '16px',
                                                ...
                                                <div className="d-flex mb-3">
                                                    <select
                                                        ...
                                                        style={{
                                                            ...
                                                            padding: '5px 10px',
                                                            borderRadius: '5px',
                                                            border: '1px solid #ced4da', background: 'linear-gradient(45deg, #4CAF50, #81C784)', // Linear gradient
                                                            fontSize: '14px',
                                                            color: 'white',
                                                            cursor: 'pointer',
                                                                        ...
                                                                        <tr>
                                                                            <td colSpan="2" className="text-center">
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    onClick={() => handleDelete(item.id)} // Delete handler
                                                                                >
                                                    ...
                                                    <div className="mt-5">
                                                        ...
                                                        <form onSubmit={handleFormSubmit} className="p-3">
                                                            ...
                                                            <div className="mb-3">
                                                                ...
                                                                <input
                                                                    type="number"
                                                                    className="form-control" id="id_benh_nhan"
                                            ...
                                            <div className="treatment-plan">
                                                ...
                                                <div className="container mt-5">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-6 mb-4"> <h4 className="mb-3">Kê Thuốc</h4>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                                                            <div style={{ display: 'flex', alignItems: 'center', marginRight: '20px' }}>
                                                                                <input
                                                                                    name="ten_duoc_pham" type="number"
                                                                                    min="1"
                                                                                    max="10"
                                                                                    value={1}
                                                                                    style={{
                                                        ...
                                                        <div className="col-md-6 mb-4"> <h4 className="mb-3">Tìm Thuốc</h4>
                                                            <div className="p-4 border rounded shadow-sm">
                                                                <input
                                                                    type="text"
                                                                    className="form-control"
