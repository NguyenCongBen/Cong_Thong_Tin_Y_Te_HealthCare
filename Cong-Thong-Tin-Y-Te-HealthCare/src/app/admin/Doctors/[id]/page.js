...
export default function DoctorDetail({ params }) {
    ...
    const { data, error } = useSWR(`http://localhost:3000/doctor/${params.id}`, fetcher);
    useEffect(() => {
        if (data) {
            Setdoctor(data);
            console.log(data);
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <p>+{doctor.so_dien_thoai}</p>
                                    <small class="text-muted">Ngày Sinh: </small>
                                    <p class="m-b-0">{doctor.ngay_sinh}</p>
                                    <small class="text-muted">Giới Tính: </small>
                                    <p class="m-b-0">{doctor.gioi_tinh}</p>
                                </div>
                            </div>
