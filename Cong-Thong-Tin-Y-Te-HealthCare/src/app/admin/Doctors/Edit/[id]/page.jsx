...
export default function EditDoctor({ params }) {
    ...
    useEffect(() => {
        ...
        const getDoctor = async () => {
            ...
            setValue('id_chuyen_khoa', data.id_chuyen_khoa);
            setValue('ten_chuyen_khoa', data.ten_chuyen_khoa);
            setValue('gioi_tinh', data.gioi_tinh);
            setValue('dia_chi', data.dia_chi);
            setValue('ngay_sinh', data.ngay_sinh.split('T')[0]);
    ...
    const onSubmit = async (data) => {
        console.log("Giá trị id_chuyen_khoa:", data.id_chuyen_khoa);
                    ...
                    <div class="block-header">
                        <div class="row">
                            <div class="col-lg-6 col-md-8 col-sm-12">
                                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Hồ Sơ Bác Sĩ</h2>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html"><i class="icon-home"></i></a></li>
                                    <li class="breadcrumb-item">Bác Sĩ</li>
                            ...
                            <div class="card profile-header">
                                <div class="body">
                                    <div class="profile-image">
                                        ...
                                        /> </div>
                                    <div>
                                        <h4 class="m-b-0"><strong>{doctor?.ten}</strong> </h4>
                            ...
                            <div class="card">
                                <div class="body">
                                    <ul class="nav nav-tabs-new">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Basic">Thông tin</a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">Tài khoản</a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#General">Giới tính</a></li>
                                    </ul>
                                </div>
                            </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="form-group">
                                                            <input type="text"
                                                                ...
                                                                {...register('ten', { required: 'Họ tên là bắt buộc' })} />
                                                            {errors.ten && <div className="text-danger">{errors.ten.message}</div>}
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text"
                                                                class="form-control"
                                                                placeholder="Địa chỉ"
                                                                {...register('dia_chi', { required: 'Địa chỉ là bắt buộc' })}
                                                            />
                                                            {errors.dia_chi && <div className="text-danger">{errors.dia_chi.message}</div>}
                                                        </div>
                                                        <div className="col-sm-13">
                                                            <div className="form-group">
                                                                <select className="form-control show-tick"
                                                                    name="gioi_tinh"
                                                                    {...register('gioi_tinh', { required: 'Giới tính là bắt buộc' })}
                                                                >
                                                                    <option value="">Giới Tính</option>
                                                                    <option value="Nam">Nam</option>
                                                                    <option value="Nữ">Nữ</option>
                                                                </select>
                                                                {errors.gioi_tinh && <div className="text-danger">{errors.gioi_tinh.message}</div>}
                                                            </div>
                                                        </div>
                                                        <div className="col-sm-13">
                                                            <div className="form-group">
                                                                <label htmlFor="ngay_sinh" className="form-label">Ngày Sinh:</label>
                                                                <input type="date" className="form-control" {...register('ngay_sinh')} />
                                                            </div>
                                                        </div>
                                                        <div className="col-sm-13">
                                                            <div className="form-group">
                                                                <label htmlFor="id_chuyen_khoa" className="form-label">Chọn Chuyên Khoa:</label>
                                                                <select
                                                                    className="form-control show-tick"
                                                                    id="id_chuyen_khoa"
                                                                    {...register('id_chuyen_khoa', { required: 'Id chuyên khoa là bắt buộc' })}
                                                                    onChange={(e) => {
                                                                        const selectedId = parseInt(e.target.value);
                                                                        const selectedCategory = chuyenkhoa.find(category => category.id === selectedId);
                                                                        setValue('ten_chuyen_khoa', selectedCategory ? selectedCategory.ten_chuyen_khoa : "");
                                                                    }}
                                                                >
                                                                ...
                                                                {errors.id_chuyen_khoa && <div className="text-danger">{errors.id_chuyen_khoa.message}</div>}
                                                            </div>
                                                        </div>

                                                        <div className="col-sm-13">
                                                            <div className="form-group">
                                                                <label htmlFor="ten_chuyen_khoa" className="form-label">Tên Chuyên Khoa:</label>
                                                                <input
                                                                    type="text"
                                                                    className="form-control"
                                                                    id="ten_chuyen_khoa"
                                                                    {...register('ten_chuyen_khoa', { required: 'Tên chuyên khoa là bắt buộc' })}
                                                                    readOnly
                                                                    placeholder="Tên Chuyên khoa"
                                                                />
                                                                {errors.ten_chuyen_khoa && <div className="text-danger">{errors.ten_chuyen_khoa.message}</div>}
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="form-group">
                                                            <input type="number" class="form-control" placeholder="Điện Thoại"
                                                                {...register('so_dien_thoai', { required: 'Số điện thoại là bắt buộc' })}
                                                            />
                                                            {errors.so_dien_thoai && <div className="text-danger">{errors.so_dien_thoai.message}</div>}
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div className="col-sm-13">
                                                            <div className="form-group">
                                                                <img src={`http://localhost:3000/images/img/bác sĩ/${doctor?.anh}`} />
                                                                <input
                                                                    type="file"
                                                                    ...
                                                                    {...register('anh')}
                                                                />
                                                                {errors.anh && <div className="text-danger">{errors.anh.message}</div>}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="submit" class="btn btn-primary">Cập nhật</button> &nbsp;&nbsp;
                                                <Link href="/admin/Doctors" type="button" class="btn btn-default">Cancel</Link>
                                            </form>
