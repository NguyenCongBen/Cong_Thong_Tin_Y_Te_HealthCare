...
export default async function search(params) {
    console.log(params);
    const res = await fetch('http://localhost:3000/benhvien/search/' + params.searchParams.keyword, { cache: 'no-store' });
        ...
        <>
            ...
            <div className="container-all">
                <div class="cover-list-news">
                    ...
                    <div class="name-cate-cover">Kết quả tìm kiếm</div>
                ...
                <div className="container-body">
                    <div className="container-1">
                        <div class="tt-bread">
                            ...
                            <p class="tt-item tt-item-1 tt-item-color">Kết quả tìm kiếm</p>
                        </div>
                        <div className="kq-tk-all">
                            <h3 className="kq-tk">{params.searchParams.keyword}</h3>
                        </div>
                        <div class="gt-related-posts">
                            ...
                            <div class="tt-thanhtich-nhieu">
                                <TatCaBenhVien data={productSearch} />
                            </div>
