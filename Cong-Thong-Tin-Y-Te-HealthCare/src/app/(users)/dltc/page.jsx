...
export default function DatLichThanhCong() {
  ...
  const { data, error, isLoading } = useSWR(
    "http://localhost:3000/lichhen/benh_nhan/1",
    fetcher
  );
            ...
            <div className="modal-header" id="dltc-boder">
              <h1 className="modal-title fs-5" id="exampleModalLabel">
                <div className="dltc-img">
                  <img
                    src="/images/img/đặt lịch thành công/Check_info.png"
                    alt=""
                  />
                  <button
                    type="button"
              ...
              <div className="modal-body" id="dltc-name">
                <h2 className="dltc-sm-title_cate_news">
                  Thông tin đã được ghi nhận
                </h2>
                <p className="dltc-ly">
                  *Lưu ý: Thời gian khám trên chưa được xác nhận, tổng đài sẽ
                  liên hệ xác nhận thời gian khám chính xác tới quý khách hàng.
                  Cảm ơn quý khách hàng đã sử dụng dịch vụ của Vinmec
                </p>
                <p className="dltc-email">
                  Email thông tin lịch hẹn đã được gửi cho quý khách (nếu quý
                  khách để lại email chính xác)
                </p> 
                {data.map((datlich) => {
                <div className="dltc-bg-all">
                  <div className="dltc-bg">
                    <div className="dltc-bg-1">
                      <div className="dltc-dv">
                        <img
                          src="/images/images/img/đặt lịch thành công/Service.png"
                          alt=""
                        />
                        <p>
                          <b>Dịch vụ</b>
                  ...
                  <div className="dltc-bg">
                    <div className="dltc-bg-1">
                      <div className="dltc-dv">
                        <img
                          src="/images/images/img/đặt lịch thành công/Customer.png"
                          alt=""
                        />
                        <p>
                          <b>Khách hàng</b>
                      ...
                      <div className="dltc-flex">
                        <p>Họ tên</p>
                        <p>{datlich.ten_benh_nhan}</p>
                      </div>
                      <div className="dltc-flex">
                        <p>Ngày tháng năm sinh</p>
                        <p>{datlich.ngay_sinh}</p>
                      </div>
                      <div className="dltc-flex">
                        <p>Giới tính</p>
                        <p>{datlich.gioi_tinh}</p>
                      </div>
                      <div className="dltc-flex">
                        <p>Số điện thoại</p>
                        <p>{datlich.so_dien_thoai}</p>
                      </div>
                      <div className="dltc-flex">
                        <p>Email</p>
                        <p>{datlich.email}</p>
                  ...
                  <div className="dltc-bg">
                    <div className="dltc-bg-1">
                      <div className="dltc-dv">
                        <img
                          src="/images/images/img/đặt lịch thành công/Doctor.png"
                          alt=""
                        />
                        <p>
                          <b>Bác sĩ</b>
                      ...
                      <div className="dltc-flex">
                        <p>Thời gian khám</p>
                        <p>{datlich.thoi_gian_hen}</p>
                      </div>
                      <div className="dltc-flex">
                        <p>Bệnh viện/Phòng khám</p>
                        <p>{datlich.ten_benh_vien}</p>
                      </div>
                      <div className="dltc-flex">
                        <p>Chuyên khoa</p>
                        <p>{datlich.ten_chuyen_khoa}</p>
                      ...
                      <div className="dltc-flex">
                        <p>Bác sĩ</p>
                        <p>{datlich.ten_bac_si}</p>
                      </div>
                    </div>
                  </div>
                  <p className="dltc-ly">
                    <i>
                      *Nếu quý khách cần thay đổi/huỷ lịch hẹn, vui lòng để lại
                      yêu cầu
        ...
        <div class="container-body">
          <div class="container-1">
            <div class="tt-bread">
              ...
              <a href="#" class="tt-item tt-item-1 tt-item-color">
                Đăng ký khám
              </a>
            </div>
            <div class="lk-content_info_book-1">
              <div class="lk-content_info_book">
                <h2 class="sm-title_cate_news">Nội dung chi tiết đặt hẹn</h2>
                <div class="lk-list_two_booking">
                  <div class="lk-col6 lk-right">
                    ...
                    <div class="lk-mb2">
                      <p class="lk-color-blue">Bác sĩ</p>
                      <select
                        class="form-select form-select-lg mb-3"
                        id="lk-form-select"
                      >
                ...
                <div class="lk-mt60">
                  <h2 class="sm-title_cate_news">Thông tin khách hàng</h2>
