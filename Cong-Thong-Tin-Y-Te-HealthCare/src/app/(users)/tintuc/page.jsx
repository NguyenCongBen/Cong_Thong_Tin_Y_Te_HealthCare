                            ...
                            <div className="tt-bottom-new">
                                ...
                                <div className="tt-thanhtich-nhieu">
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-4.jpg"
                                                    alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">GS Nguyễn Thanh Liêm được vinh danh
                                                        là 1 trong 100 nhà khoa học tiêu biểu châu Á 2019</h5>
                                                </a>
                                                <p className="card-text" id="card-text">Năm 2019, Việt Nam có hai nhà khoa học của
                                    ...
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-5.jpg"
                                                    alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">GS Nguyễn Thanh Liêm được trao danh
                                                        hiệu “Công dân thủ đô ưu tú”</h5>
                                                </a>
                                                <p className="card-text" id="card-text">Sáng 5/10, tại Hội nghị biểu dương điển hình
                                                    tiên tiến, người tốt, việc tốt tiêu biểu vinh danh Công dân Thủ đô ưu tú của
                                                    TP Hà Nội, GS...
                                                </p>
                                                <a href="#" className="btn" id="tt-xemthem">Xem thêm
                                                    <span className="btn-size">
                                    ...
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-6.jpg"
                                                    alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">Healthcare Times City được công nhận
                                                        là 1 trong 15 bệnh viện làm tốt công tác cảnh giác dược (ADR) năm 2018
                                                    </h5>
                                                </a>
                                                <p className="card-text" id="card-text">Tại Hội nghị Cảnh giác Dược toàn quốc năm
                                                    2019 ngày 23 – 24/8 vừa qua, Bệnh viện Healthcare Times City là 1 trong 15
                                                    đơn
                                                    vị được khen thưởn...
                                                </p>
                                                <a href="#" className="btn" id="tt-xemthem">Xem thêm
                                    ...
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-7.jpg"
                                                    alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">Healthcare được vinh danh là “Bệnh
                                                        viện tiến bộ nhất” và “An toàn cho người bệnh”</h5>
                                                </a>
                                                <p className="card-text" id="card-text">Ngày 12/9, tại Hà Nội, Hệ thống Y tế
                                                    Healthcare
                                                    đã được Hiệp hội Quản lý Bệnh viện Châu Á vinh danh là “Bệnh viện Việt Nam
                                                    tiến bộ nhất”...
                                                </p>
                                                <a href="#" className="btn" id="tt-xemthem">Xem thêm
                                                    <span className="btn-size">
                                    ...
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-8.jpg"
                                                    alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">Nuôi cấy tăng sinh EX vivo tế bào
                                                        diệt tự nhiên và tế bào tê gây độc từ máu ngoại vi các bệnh nhân ung thư
                                                        phổi</h5>
                                                </a>
                                                <p className="card-text" id="card-text">Tác giả: Hoàng Thị Mỹ Nhung 1,2*, Bùi Việt
                                                    Anh 1*, Trương Linh Huyền 1, Đoàn Trung Hiệp 3, Chu Thị Thảo 1, Phùng Nam
                                                    Lâm 3, và Nguyễn...
                                                </p>
                                                <a href="#" className="btn" id="tt-xemthem">Xem thêm
                                                    <span className="btn-size">
                                    ...
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-9.jpg" alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">Sự khác biệt về cải thiện tỷ lệ sống
                                                        sót sau chẩn đoán ung thư bạch huyết theo chủng tộc, tuổi và giới: những
                                                        kết quả thu được từ một nghiên cứu dựa trên cộng đồng.</h5>
                                                </a>
                                                <p className="card-text" id="card-text">Đánh giá cải thiện tỷ lệ sống sót của bệnh
                                                    nhân ung thư bạch huyết từ năm 1990 đến năm 2014, phân tầng theo tuổi, giới
                                                    và chủng tộc sử dụng...
                                                </p>
                                                <a href="#" className="btn" id="tt-xemthem">Xem thêm
                                                    <span className="btn-size">
                                                        <img src="/images/img/thông tin/product/icon-2.png" alt="" />
                                    ...
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-10.jpg" alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">Đánh giá ảnh hưởng của sự thay đổi
                                                        thể tích bàng quang đến sai số cài đặt ở các bệnh nhân xạ trị ung thư
                                                        vùng tiểu khung tại Bệnh viện đa khoa Quốc tế Healthcare Times City</h5>
                                                </a>
                                                <p className="card-text" id="card-text">Tổng số 7 bệnh nhân ung thư vùng tiểu khung
                                                    (ung thư trực tràng thấp, ung thư cổ tử cung, buồng trứng) được chỉ định xạ
                                                    trị hậu phẫu tại...
                                                </p>
                                                <a href="#" className="btn" id="tt-xemthem">Xem thêm
                                                    <span className="btn-size">
                                    ...
                                    <div className="tt-thanhtich-nhieu-1">
                                        <div className="card card-thanhtich" id="card-boder">
                                            <a href="#">
                                                <img className="cart-anh card-img-top" src="/images/img/thông tin/product/pro-11.jpg" alt="..." />
                                            </a>
                                            <div className="card-body" id="card-body">
                                                <a href="#">
                                                    <h5 className="card-title" id="card-title">Đánh giá kết quả bước đầu phẫu thuật
                                                        nội soi có sử dụng hệ thống Robot Da Vinci tại Bệnh viện Đa khoa Quốc tế
                                                        Healthcare</h5>
                                                </a>
                                                <p className="card-text" id="card-text">Nguyễn Hùng Cường * , Nguyễn Ngọc Khánh * ,
                                                    Vũ Ngọc Thắng * , Nguyễn Thu Hoài * , Hoàng Thọ * , Phùng Quang Thủy*.
                                                </p>
                                                <a href="#" className="btn" id="tt-xemthem">Xem thêm
                                                    <span className="btn-size">
                                                        <img src="/images/img/thông tin/product/icon-2.png" alt="" />
