...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // On successful login, store the JWT token and display success message
      ...
      setTimeout(() => {
        if (userRole === "Bệnh nhân") {
          ...
          window.location.href = "/"; // Adjust this URL based on your routing
        } else if (userRole === "Bác sĩ") {
          // Redirect to the admin page for doctor
          window.location.href = "/admin"; // Adjust based on your route
        }
      }, 1000);
    } catch (error) {
