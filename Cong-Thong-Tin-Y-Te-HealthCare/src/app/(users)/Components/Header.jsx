                  ...
                  <ul class="navbar-nav" id="tt-menu">
                    <li class="nav-item">
                      ...
                      <div class="drop-down-menu">
                        <ul>
                          ...
                          <li class="sub-menu-item">
                            <Link href="#">Miễn dịch - Dị ứng</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Tiêu hoá - Gan mật</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Nhi</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Sức khoẻ phụ nữ</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Thẩm mỹ Vinmec-View</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Sức khoẻ tổng quát</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Mắt Vinmec-Alina</Link>
                          </li>
                        </ul>
                        <ul>
                          <li class="sub-menu-item">
                            <Link href="#">Nha khoa Vinmec View Premium</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">
                          ...
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Công nghệ cao</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">
                          ...
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Vacxin</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Vú</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Thần kinh</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">
                    ...
                    <li class="nav-item">
                      ...
                      <div class="drop-down-menu">
                        <ul>
                          ...
                          <li class="sub-menu-item">
                            <Link href="/hethong">Hệ thống Vinmec</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="/timbacsi">Tìm bác sĩ</Link>
                          </li>
                          ...
                          <li class="sub-menu-item">
                            <Link href="/baohiem">Dịch vụ bảo hiểm</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Dịch vụ y tế</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Thông tin hỗ trợ khác</Link>
                          </li>
                        </ul>
                      </div>
                    </li>
                    <li class="nav-item">
                      <Link class="nav-link" href="/hoatdong">
                        Hoạt động vì cộng đồng
                      </Link>
                    </li>
                    <li class="nav-item">
                      <Link class="nav-link" href="/tintuc">
                        Về Healthcare
                      </Link>
                      <div class="muinhon"></div>
                      <div class="drop-down-menu">
                        <ul>
                          ...
                          <li class="sub-menu-item">
                            <Link href="/doitac">Đối tác của Vinmec</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Làm việc tại Vinmec</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="/tintuc">Tin tức</Link>
                          </li>
                    ...
                    <li class="nav-item">
                      ...
                      <div class="drop-down-menu" style={{ right: "0" }}>
                        <ul>
                          <li class="sub-menu-item">
                            <Link href="/tintuc">Tổng hợp</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="/tracuubenh">Tra cứu bệnh</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="/cothenguoi">Hiểu về cơ thể bạn</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Tim mạch</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Ung bướu</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Miễn dịch - Dị ứng</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Tiêu hóa - Gan mật</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Nhi</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm sức khỏe phụ nữ</Link>
                          </li>
                        </ul>
                        <ul>
                          <li class="sub-menu-item">
                          ...
                          <li class="sub-menu-item">
                            <Link href="#">Thẩm mỹ</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Y học cổ truyền</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Tế bào gốc và Công nghệ Gen</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Trung tâm Công nghệ cao</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Sức khỏe tổng quát</Link>
                          </li>
                          <li class="sub-menu-item">
                            <Link href="#">Hỏi đáp bác sĩ</Link>
                          </li>
                        </ul>
                      </div>
                    </li>
