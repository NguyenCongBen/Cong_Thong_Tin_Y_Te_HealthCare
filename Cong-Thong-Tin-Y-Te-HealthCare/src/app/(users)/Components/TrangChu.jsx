            ...
            <div class="container-all">
                <div class="banner-homepage">
                    <div class="banner-slider">
                        <div class="banner-responsive">
                            <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/banner-1.png" class="d-block w-100" alt="..." />
                                    </div>
                                    <div class="carousel-item" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/banner-2.png" class="d-block w-100" alt="..." />
                                    </div>
                                    <div class="carousel-item" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/banner-3.jpg" class="d-block w-100" alt="..." />
                                    </div>
                                    <div class="carousel-item" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/banner-4.png" class="d-block w-100" alt="..." />
                                    </div>
                                    <div class="carousel-item" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/banner-5.png" class="d-block w-100" alt="..." />
                                    </div>
                                    <div class="carousel-item" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/banner-6.png" class="d-block w-100" alt="..." />
                                    </div>
                                </div>
                        ...
                        <div class="banner-responsive-1">
                            <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/rp-1.jpg" class="d-block w-100" alt="..." />
                                    </div>
                                    <div class="carousel-item" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/rp-3.png" class="d-block w-100" alt="..." />
                                    </div>
                                    <div class="carousel-item" data-bs-interval="4000" id="carousel">
                                        <img src="/images/img/Trang chủ/rp-4.jpg" class="d-block w-100" alt="..." />
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button"
                                    data-bs-target="#carouselExampleAutoplaying" data-bs-slide="prev">
                    ...
                    <div class="banner-content">
                        <div class="container-1">
                            <div class="text-banner">
                                <h1 class="title-banner">Chăm sóc bằng tài năng, y đức và sự thấu cảm</h1>
                                <div class="desc-banner">
                                    Vinmec cam kết về trách nhiệm xã hội và đóng góp tích cực vào sự phát triển bền vững của
                                    cộng đồng
                                </div>
                                <Link href="#" class="home-viewmore-button">Xem thêm</Link>
                            </div>
                            <div class="cta-banner home-flex">
                                <button type="button" class="btn btn-primary home-col-4 cta-item" id="home-btn-goi"
                                    ...
                                    <div class="cta-info">
                                        ...
                                        <div class="cta-desc"> Hỏi về phương pháp điều trị và phương pháp của chúng tôi
                                        </div>
                                    </div>
                                </button>
                                <Link href="/datlich" class="home-col-4 cta-item">
                                    <div class="cta-icon">
                                        <img src="/images/img/Trang chủ/appoinment.png" alt="" />
                                    </div>
                                    <div class="cta-info">
                                        <div class="cta-name">Đặt lịch hẹn</div>
                                        <div class="cta-desc"> Đặt lịch hẹn với bệnh viện của chúng tôi
                                        </div>
                                    </div>
                                </Link>
                                <Link href="/timbacsi" class="home-col-4 cta-item">
                                    <div class="cta-icon">
                                        <img src="/images/img/Trang chủ/doctor.png" alt="" />
                                    </div>
                                    <div class="cta-info">
                                        <div class="cta-name">Tìm bác sĩ</div>
                                        <div class="cta-desc"> Chọn theo tên, chuyên môn và nhiều hơn thế
                                        </div>
                                    </div>
                                </Link>
                            </div>
                ...
                <div class="container-body">
                    <div class="container-1">
                        <div class="home-why-us">
                            <h2 class="sm-title_cate_news">Tại sao nên chọn Healthcare</h2>
                        </div>
                        <div class="home-flex">
                            <div class="home-col-5">
                                <img src="/images/img/Trang chủ/pro-1.png" alt="" />
                            </div>
                            <div class="home-col-7">
                                <div class="list-whyus home-flex">
                    ...
                    <div class="certifi">
                        <div class="container-1">
                            <div class="home-flex home-items-center">
                                <div class="home-col-6 home-rpw">
                                    <div class="home-sect-head">
                                        <h2 class="sm-title_cate_news color">Chứng nhận và giải thưởng</h2>
                                        <div class="sect-desc">
                                            Vinmec tự hào được các tổ chức uy tín trên thế giới công nhận
                                        </div>
                                        <Link href="#" class="viewmore-button">
                                            Xem thêm
                                ...
                                <div class="home-col-6 home-rpw">
                                    <div class="home-list-certifi home-flex">
                                        <div class="home-glide__slides">
                    ...
                    <div class="home-clinic-system">
                        <div class="container-1">
                            <div class="home-flex home-width">
                                <div class="home-col-6 clinic-large home-rpw">
                                    <div class="home-list-clinic-large">
                                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active" data-bs-interval="2000">
                                                    <img src="/images/img/Trang chủ/pro-8.jpg" class="d-block w-100" alt="..." />
                                                </div>
                                                <div class="carousel-item" data-bs-interval="2000">
                                                    <img src="/images/img/Trang chủ/pro-6.jpg" class="d-block w-100" alt="..." />
                                                </div>
                                                <div class="carousel-item" data-bs-interval="2000">
                                                    <img src="/images/img/Trang chủ/pro-7.jpg" class="d-block w-100" alt="..." />
                                                </div>
                                            </div>
                                            <button class="carousel-control-prev" type="button" id="home-boder"
                                                data-bs-target="#carouselExampleInterval" data-bs-slide="prev">
                                                <span class="carousel-control-prev-icon" id="home-f10"
                                                    aria-hidden="true"></span>
                                                <span class="visually-hidden">Previous</span>
                                            </button>
                                            <button class="carousel-control-next" type="button" id="home-boder"
                                                data-bs-target="#carouselExampleInterval" data-bs-slide="next">
                                                <span class="carousel-control-next-icon" id="home-f10"
                                                    aria-hidden="true"></span>
                                                <span class="visually-hidden">Next</span>
                                            </button>
                                        </div>
                                ...
                                <div class="home-col-6 home-rpw">
                                    <div class="home-sect-head">
                                        <h2 class="sm-title_cate_news">Hệ thống phòng khám và trung tâm của chúng tôi</h2>
                                        <div class="home-sect-desc home-mb15">
                                    ...
                                    <div class="home-list-clinic-thumb home-flex home-mt30 home-items-center">
                                        <div class="home-glide__slides home-icon-slice active">
                                            <img src="/images/img/Trang chủ/pro-8.jpg" alt="" />
                                        </div>
                                        <div class="home-glide__slides home-icon-slice">
                            ...
                            <div class="home-col-12 home-justify-content-center">
                                <Link href="#" class="home-icon viewmore-button">Xem thêm</Link>
                            </div>
                            <div class="home-news">
                                ...
                                <div class="tt-medium">
                                    <div class="card" id="card-boder-medium">
                                        ...
                                        <div class="card-body" id="card-medium">
                                            <Link href="#">
                                                <p class="card-text" id="tt-medium-size">Healthcare công bố ca mổ tim hở
                                    ...
                                    <div class="card" id="card-boder-medium">
                                        ...
                                        <div class="card-body" id="card-medium">
                                            <Link href="#">
                                                <p class="card-text" id="tt-medium-size">Ung thư xương: Mẹ của “chiến binh”
                                    ...
                                    <div class="card" id="card-boder-medium">
                                        ...
                                        <div class="card-body" id="card-medium">
                                            <Link href="#">
                                                <p class="card-text" id="tt-medium-size">Healthcare phẫu thuật thành công
                    ...
                    <div class="container-1">
                        <div class="home-partner home-mt30">
                            <h2 class="sm-title_cate_news h3">Đối tác của chúng tôi</h2>
                            <div class="home-list-partner">
                                <div class="home-glide__track home-flex ">
                                    <div class="home-hospital_slides">
