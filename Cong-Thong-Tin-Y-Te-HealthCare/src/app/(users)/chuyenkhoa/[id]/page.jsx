...
export default function ChuyenKhoa({ params }) {
    ...
    const { data: chuyenkhoa, error: errorChuyenkhoa, isLoading: isLoadingChuyenKhoa } = useSWR(`http://localhost:3000/chuyenkhoa/${params.id}`, fetcher);
    if (errorChuyenkhoa) return <strong>Lỗi...</strong>
    if (isLoadingChuyenKhoa) return <strong>Lỗi load dữ liệu...</strong>
    return (
        <>
            <main>
                <GoiTongDai />
                <div class="container-all">
                    <div class="cover-list-news">
                        ...
                        <div class="name-cate-cover">{chuyenkhoa.ten_chuyen_khoa}
                        </div>
                    ...
                    <div class="container-body">
                        <div class="container-1">
                            <div class="tt-bread">
                                ...
                                <Link href="/hethong" class="tt-item">Hệ thống bệnh viện</Link>
                                <i class="fa-solid fa-angle-right tt-item gt-item"></i>
                                <p href="#" class="tt-item tt-item-1 tt-item-color">{chuyenkhoa.ten_chuyen_khoa}</p>
                            </div>
                            <div class="ht-hospital-detail">
                                <div class="ht-hospital-header">
                                    <h1 class="sm-title_cate_news">{chuyenkhoa.ten_chuyen_khoa}</h1>
