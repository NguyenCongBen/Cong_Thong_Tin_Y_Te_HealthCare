            ...
            <form onSubmit={handleSubmit} className="lk-content_info_book">
              ...
              <div className="lk-list_two_booking lk-mbt-1">
                ...
                <div className="lk-col6 lk-left">
                  <div className="lk-mb2">
                    <p className="lk-color-blue">
                      Ngày tháng năm sinh<span className="lk-color-red">*</span>
                    </p>
                    <input
                      className="lk-input-2"
                      name="ngaySinh"
                ...
                <div className="lk-col12">
                  <div className="lk-mb2">
                    ...
                    <textarea
                      className="lk-textarea-2"
                      name="lyDoKham"
                      cols="50"
                      rows="4"
                      placeholder="Vui lòng mô tả cụ thể các triệu chứng của anh/chị đang gặp phải"
                      onChange={handleInputChange}
                      required
                    ></textarea>
                  </div>
