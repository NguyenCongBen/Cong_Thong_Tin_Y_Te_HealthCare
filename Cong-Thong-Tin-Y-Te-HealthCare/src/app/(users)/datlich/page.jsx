                    ...
                    <div className="container-1">
                        ...
                        <form onSubmit={handleSubmit} className="lk-content_info_book">
                            <div className="lk-list_two_booking">
                                <div className="lk-col6 lk-right">
                                    <div className="lk-mb2">
                                        ...
                                        <select onChange={(e) => { setFormData({ ...formData, idBenhVien: e.target.value }) }} className="form-select form-select-lg mb-3" id="lk-form-select" required>
                                    ...
                                    <div className="lk-mb2">
                                        ...
                                        <select onChange={handleChuyenKhoaChange} className="form-select form-select-lg mb-3" id="lk-form-select" required>
                                    ...
                                    <div className="lk-mb2">
                                        ...
                                        <select onChange={(e) => { setFormData({ ...formData, idBacSi: e.target.value }) }} className="form-select form-select-lg mb-3" id="lk-form-select" required>
                                ...
                                <div className="lk-list_two_booking lk-mbt-1">
                                    <div className="lk-col6 lk-right">
                                        <div className="lk-mb2 lk-mbt">
                                            ...
                                            <div className="lk-input">
                                                <input className="lk-input-1" name="hoTen" type="text" placeholder="Họ và tên" id="lk-form-select" onChange={handleInputChange} required />
                                        ...
                                        <div className="lk-mb2 lk-mbt">
                                            ...
                                            <div class="lk-input">
                                                <input className="lk-input-2" name="soDienThoai" type="text" placeholder="Nhập số điện thoại" id="lk-form-select" onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="lk-col6 lk-left">
                                        <div className="lk-mb2 lk-mbt">
                                            ...
                                            <div className="lk-input">
                                                <input className="lk-input-2" name="ngaySinh" type="date" id="lk-form-select" onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                        <div className="lk-mb2">
                                            <p className="lk-color-blue">Email<span className="lk-color-red">*</span></p>
                                            <div class="lk-input">
                                                <input className="lk-input-2" name="email" type="email" id="lk-form-select" placeholder="Nhập email" onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="lk-col12">
                                        <div className="lk-mb2 lk-mbt">
                                            ...
                                            <div class="lk-input">
                                                <textarea className="lk-input-2" name="lyDoKham" rows="4" id="lk-form-select" placeholder="Nhập lý do khám" onChange={handleInputChange} required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="lk-text-center">
                                <button type="submit" className="lk-btn_send_book">Gửi thông tin</button>
                            </div>
                        </form>
                        {isSuccess && (
                            routor.push('/dltc')
